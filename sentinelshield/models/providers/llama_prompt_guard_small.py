...
class LlamaPromptGuard2SmallProvider:
    name = "llama_prompt_guard_2_22m"
    ...
    def __init__(self) -> None:
        ...
        try:  # pragma: no cover - optional dependency
            ...
            logger.warning("Failed to load Llama Prompt Guard 2 22M model: %s", e)
...
provider = LlamaPromptGuard2SmallProvider()
