...
orc = build_orchestrator(
    ...
    api_path="/v1/full-prompt-guard",
)


class FullPromptGuardRequest(BaseModel):
    prompt: str


@router.post("/v1/full-prompt-guard")
async def full_prompt_guard(req: FullPromptGuardRequest):
